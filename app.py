...
def send_data(token, sensor_data_1, sensor_data_2, acc_power_1, acc_power_2):
    ...
    data = {
        "data": [
            {"type": "BATTERY_VOLTAGE", "value": sensor_data_1["voltage"], "channel": 0},
            {"type": "ELECTRIC_CURRENT", "value": sensor_data_1["current"], "channel": 0},
            {"type": "ELECTRICAL_CONSUMPTION", "value": sensor_data_1["power"], "channel": 0},
            {"type": "ELECTRICAL_CONSUMPTION", "value": acc_power_1, "channel": 2},
            {"type": "BATTERY_VOLTAGE", "value": sensor_data_2["voltage"], "channel": 1},
            {"type": "ELECTRIC_CURRENT", "value": sensor_data_2["current"], "channel": 1},
            {"type": "ELECTRICAL_CONSUMPTION", "value": sensor_data_2["power"], "channel": 1},
            {"type": "ELECTRICAL_CONSUMPTION", "value": acc_power_2, "channel": 3},
            {"type": "ELECTRICAL_CONSUMPTION", "value": acc_power_1 + acc_power_2, "channel": 4},
            {"type": "ELECTRICAL_CONSUMPTION", "value": sensor_data_1["power"] + sensor_data_2["power"], "channel": 5},
        ]
    }
    try:
        ...
        while True:
            ...
            if sensor_data:
                try:
                    ...
                    accumulated_power_1 += (power_1 / 1000) * time_interval  # Convert to Watt-seconds (Joules)
                    accumulated_power_2 += (power_2 / 1000) * time_interval  # Convert to Watt-seconds (Joules)
